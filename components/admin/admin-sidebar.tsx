...
import { Clapperboard, ShieldCheck, LogOut } from 'lucide-react'
    ...
    <div className="flex h-full flex-col">
      ...
      >
        ...
        <span className="flex flex-col leading-none">
          ...
          <span className="mt-1 inline-flex w-fit items-center gap-1 rounded bg-cta-red/20 px-1.5 py-0.5 font-display text-[10px] font-bold uppercase tracking-[0.15em] text-cta-red">
